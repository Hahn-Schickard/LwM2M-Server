...
Register_Request::Register_Request(
    string endpoint_name, string endpoint_address, unsigned int endpoint_port,
    ...
    : Regirstration_Interface_Message(MessageType::REGISTER),
      endpoint_name_(move(endpoint_name)),
      endpoint_address_(move(endpoint_address)), endpoint_port_(endpoint_port),
      life_time_(life_time), version_(version), binding_(binding),
      queue_mode_(queue_mode), sms_number_(move(sms_number)),
